# 🏗️ Create: Design n' Decor Legacy Fix 🔧

**Create: Design n' Decor Legacy Fix** is a compatibility-focused fork of **Design n' Decor** for **Minecraft 1.20.1**, **Forge**, and **Create 6**. 🚂⚙️
...
**Create: Design n' Decor Legacy Fix aims to keep those worlds alive.** ❤️
...
3.  📥 Install Create: Design n' Decor Legacy Fix.
